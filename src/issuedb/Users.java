...
public class Users extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Users.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Users.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Users.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Users.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<issuedb.User> toRemove = new ArrayList<issuedb.User>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            issuedb.User u = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(u);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        issuedb.User u = new issuedb.User();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<issuedb.User> merged = new ArrayList<issuedb.User>(list.size());
            for (issuedb.User u : list) {
    ...
    private java.util.List<issuedb.User> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new Users());
